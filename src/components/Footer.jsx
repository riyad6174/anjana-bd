  ...
  return (
    <div>
      <footer class='bg-green-100'>
        <div class='mx-auto max-w-screen-xl px-4 py-10 sm:px-6 lg:px-4'>
          <div class='lg:flex lg:items-start lg:gap-8'>
            <div class='text-teal-600'>
              {/* <img
                src='./assets/onjona-logo.png'
                class='absolute top-0 right-10 w-6  hidden h-full max-w-1/2 lg:block'
              /> */}
            </div>
              ...
              <div class='col-span-2 lg:col-span-3 lg:flex lg:items-end'>
                <form class='w-full'>
                  ...
                  <div class='border border-gray-100 p-2 focus-within:ring sm:flex sm:items-center sm:gap-4'>
                    ...
                    <button class='mt-1 w-full bg-green-600 px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none hover:bg-teal-600 sm:mt-0 sm:w-auto sm:shrink-0'>
                      Sign Up
                    </button>
                  </div>
                </form>
