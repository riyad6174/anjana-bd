        ...
        <div class='mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2'>
          <div class='relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-32'>
            <div class='mx-auto max-w-xl lg:mx-0 lg:max-w-lg'>
              <div class='absolute inset-y-0 left-0 -z-10 w-full overflow-hidden bg-green-50 ring-1 ring-gray-900/10 lg:w-1/2'>
                <svg
                  class='absolute inset-0 h-full w-full stroke-green-200 [mask-image:radial-gradient(100%_100%_at_top_right,white,transparent)]'
                  aria-hidden='true'
                >
                  <defs>
                    <pattern
                  ...
                  <rect
                    ...
                    fill='white'
                  ></rect>
                  <svg x='100%' y='-1' class='overflow-visible fill-green-100'>
              ...
              <h2 class='text-3xl font-bold tracking-tight text-green-600 uppercase'>
                Contact Us
              </h2>
